...
my $dir_filter=$sample_full_path."/filtered"; 
...
my $f_esp_out=$sample_full_path."/filtered/merged_N2_R2_abundance.esp"; 
my $f_gtf_out=$sample_full_path."/filtered/merged_N2_R2_updated.gtf"; 
...
foreach my $chr (@chrlist)
	{
		...
		{ 
		$chr1="chr".$chr; 
		$f_esp_in=$sample_full_path."/".$chr1."/filtered/bam_N2_R2_abundance.esp"; 
		$f_gtf_in=$sample_full_path."/".$chr1."/filtered/bam_N2_R2_updated.gtf"; 
